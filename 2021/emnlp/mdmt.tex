...
%via the Reinforce algorithm \cite{Williams92simple}:\fyTodo{Rewrite this correctly with domain average reward}
\begin{align*}
...
\begin{table*}
  ...
  \begin{tabular}{|l|*8{r|}} \hline
    ...
    \system{CL($d$)} \hfill [BLEU]&37.2&55.4&53.0&31.3&45.3&90.8&52.2\\ \hline\hline
    % Multidomain
...
%    $ \mathcal{H}(\vlambda_*^{l})$ &  \\
  ...
  \end{tabular}
  \caption{Baseline results for DDS in fine-tuning and multi-domain adaptation. In the top part, we report scores with DDS and each target domain, and compare with full fine-tuning: each column corresponds to a distinct system. We also report the proportion of in-domain data in the final mixture. In the bottom part, we run multi-domain experiments: for a given line, all the columns \emph{correspond to the same system}. We also report the KL divergence between the optimal and the target mixtures.}
  \label{tab:basic-dds}
\end{table*}
\fyTodo{Report CL results / explain in legend}
...
This idea is reminiscent of the work of \citet{Graves17automated} and \citet{Kumar19reinforcement}, who also design their curriculum trainng strategy based on the development loss.
...
\begin{table*}
  ...
  \begin{tabular}{|l|*9{r|}} \hline
    ...
    \system{DDS-v1($\vlambda_0, \vlambda_{news}$)} &-&-&-&-&-&-&23.1 \\  \hline\hline 
    \multicolumn{9}{|c|}{\sl 30 clusters} \\ \hline
    \system{DDS-v1($\vlambda^*, \vlambda_d$)}&36.3&56.9&51.3&33.2&43.4&89.4&51.8&-
    \\  \hline\hline 
    \multicolumn{9}{|c|}{\sl Multi-domain training} \\ \hline
    \\
    \system{DDS-v1($\vlambda_0, \vlambda_d$)} &36.7&58.2&55&33.3&46.6&91.9&53.6& -\\
    \system{DDS-v1($\vlambda_1, \vlambda_d$)} &37.2&55.1&51.8&32.8&44.9&85.4&51.2&-\\
    \system{DDS-v1($\vlambda_0, \vlambda_0$)}&35.5&55.5&53.7&32.3&45.6&91.1&52.3& - \\
    \system{DDS-v1($\vlambda_1, \vlambda_0$)}&37.4&54.4&50.3&32.0&42.7&80.2&49.5&- \\
    \system{DDS-v1($\vlambda_1, \vlambda_2$)}&36.2&-&-&-&46.1&-&-&- \\
    \system{DDS-v1($\vlambda_1, \vlambda_2$)}&-&57.2&53.8&-&-&-&-&- \\
    \system{DDS-v1($\vlambda_1, \vlambda_2$)}&-&-&-&32&-&90&-&- \\ \hline
  \end{tabular}
