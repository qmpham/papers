...
\begin{table*}
  ...
  \begin{tabular}{|l|*8{r|}} \hline
    ...
    \system{DDS($\vlambda_1, \vlambda_0$)} &37.86&50.22&47.22&31.22&40.83&58.56&44.32 \\
    $\operatorname{KL}(\vlambda_*^{l}, \vlambda_0$) &36.96&55.55&52.88&33.06&44.52&91.25&52.37 \\
...
\begin{table*}
  ...
  \begin{tabular}{|l|*9{r|}} \hline
    ...
    \system{DDS-v2($\vlambda_0, \vlambda_0$)}&35.45&55.46&53.7&32.3&45.6&91.11&52.27& - \\
    \system{DDS-v1($\vlambda_1, \vlambda_0$)} & \\
    \system{DDS-v2($\vlambda_1, \vlambda_0$)} & \\ \hline
  \end{tabular}
