...
\cline{1-2} \cline{4-11}
    ...
    \cline{1-2}
     ...
     \cline{1-2}
  \end{tabular}
  \caption{Few-shot adaptation (left) and unsupervised adaptation (right). For a given line, each column corresponds to one distinct system. ($^*$) MDAC is significantly better than DDS.}
