...
\end{tabularx}}
\end{center}
\caption{BLEU score for Transformer in language pair English - German. The notation is same as \ref{tab:1}}
\label{tab:2}
\end{figure}
...
\end{tabularx}}
\end{center}
\caption{bpe-detokenized BLEU score for Recurrent network architecture on language pair English-French. Notations as same as \ref{tab:1} except that other models from WDCMT of \cite{D18-1041} use Bidirectional-LTSM}
\label{tab:3}
\end{figure}
...
\end{tabularx}}
\end{center}
\caption{BLEU score for Recurrent network on language pair English - German. The notation is same as \ref{tab:3}}
\label{tab:4}
\end{figure}
