...
To reduce the vocabulary, we apply Byte-Pair Encoding \cite{Sennrich16BPE} with 30,000 merge operations, then select approximately 30,000 the most frequent words to build vocabulary for each language.\fyTodo{I need explanations here}
