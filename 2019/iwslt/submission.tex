...
\end{center}
\caption{BPE-detokenized BLEU scores for  Transformer systems \label{tab:results-trsf}}
\end{table}
...
$\mathtt{Mixed}\ cont$             & 66.49$_{45.79}$ & 37.59 & 55.07 & 51.78 & \\
\hline
$\mathtt{LDR}_{oracle}$          & 74.26$_{49.90}$ & 37.67 & 54.07 & 13.40 & \\
$\mathtt{LDR}_{oracle}\ cont$  & 76.17$_{49.71}$ & 37.48 & 55.12 & 55.24 & \\
\hline
\end{tabular}
} %scalebox
\end{center}
