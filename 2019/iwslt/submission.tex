...
$\mathtt{FT}_{ECB}$    & 26.93 & 27.09 & 56.52 & 36.84\\
\hline
$\mathtt{DC}$              & 67.87$_{45.42}$ & 37.31 & 54.14 & 53.10\\
\hline
$\mathtt{LDR}_{oracle}$            & 74.26$_{49.90}$ & 37.67 & 54.07 & 55.33\\
$\mathtt{LDR}_{oracle}^{0.5}$   & 74.95$_{49.38}$ & 37.35 & 55.91 & 56.07\\
%$\mathtt{LDR}_{generic}$          & 73.97$_{49.54}$ & 37.81 & 53.67 & \\
$\mathtt{LDR}_{pred}$               & 74.29$_{49.84}$ & 37.73 & 54.01 & 55.34\\
...
$\mathtt{FT}_{ECB}$   & 24.72 & 18.36 & 74.05 & 39.04\\
\hline
$\mathtt{DC}$ & 63.48$_{42.98}$ & 26.27 & 66.95 & 52.23\\
\hline
$\mathtt{LDR}_{oracle}$ & 70.90$_{46.12}$ & 26.30 & 68.90 & 55.36\\
$\mathtt{LDR}_{oracle}^{0.5}$ & 71.31$_{45.23}$ & 25.98 & 73.74 & 57.01\\
%$\mathtt{LDR}_{generic}$ & 70.86$_{45.60}$ & 26.14 & 68.59 & \\
$\mathtt{LDR}_{pred}$ & 70.89$_{46.12}$ & 26.53 & 68.63 & 55.35\\
...
\hline
$\mathtt{FT}_{EMEA}$   & 72.06$_{47.33}$ & 18.62 & 16.78 & 35.82\\
...
\hline
$\mathtt{LDR}_{oracle}$            & 71.73$_{46.30}$ & 35.21 & 50.91 & 52.62\\
%$\mathtt{LDR_{condgru}}_{pred}$   & 71.7$_{46.21}$ & 35.09 & 51.22 & \\
$\mathtt{LDR}_{oracle}^{0.5}$   & 71.70$_{46.41}$ & 34.24& 52.37 & 52.77\\
%$\mathtt{LDR}_{generic}$          & 70.59$_{46.37}$ & 35.22 & 49.68 & \\
$\mathtt{LDR}_{pred}$               & 72.76$_{46.35}$ & 35.10 & 50.38 & 52.75\\
...
\hline
$\mathtt{FT}_{EMEA}$  & 65.64$_{44.71}$ & 12.36 & 15.93 & 31.31\\
$\mathtt{FT}_{EPPS}$   & 24.90$ $ & 22.98 & 26.26 & 24.71\\
$\mathtt{FT}_{ECB}$     & 41.80$ $ & 15.97 & 71.07 & 42.95\\
\hline
$\mathtt{DC}$                & 62.53$_{39.25}$ & 23.74 & 65.71 & 50.66\\
%\hline
%$\mathtt{WDCMT}$ & 64.05$_{38.54}$ & 22.82 & 67.00 & \\
\hline
$\mathtt{LDR}_{oracle}$     & 63.43$_{40.04}$ & 22.66 & 64.40 & 50.16\\
$\mathtt{LDR}_{oracle}^{0.5}$   & 63.27$_{38.16}$ & 21.83 & 69.55 & 51.55\\
...
$\mathtt{WDCMT}$                        & 68.76$_{45.29}$ & 35.71 & 52.75 & 52.40\\
\hline
\end{tabular}
} %scalebox
\end{center}
...
\hline
 ...
 size=16 & 74.15$_{49.10}$ & 37.78 & 54.56 & 55.50\\
 size=32 & 75.10$_{48.61}$ & 37.64 & 54.29 & 55.68\\
 size=64 & 74.50$_{50.17}$ & 37.27 & 54.50 & 55.42\\
\hline
\end{tabular}
} %scalebox
\end{center}
...
\hline
$\mathtt{LDR}_{oracle}$     & 74.26$_{49.90}$ & 37.67 & 54.07 & 13.40 & 44.85\\
$\mathtt{LDR}_{oracle}^*$  & 76.17$_{49.71}$ & 37.48 & 55.12 & 55.24 & 56.00\\
\hline
\end{tabular}
} %scalebox
\end{center}
