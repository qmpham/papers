...
Multi-domain Machine Translation has largely interested NLP community by its promising application in industry and its relation to fundamental problem in theory. Researchers have proposed a large range of techniques from Data centric methods to Model centric methods \cite{C18-1111}; \cite{P17-2061}. Data centric methods aim to augment in-domain training data by using data selection techniques such as 
