...
\title{A Study of Residual Adapters for Neural Machine Translation}
...
Weight decay applies a penalization on the weights of the adapters.\fyTodo{The second summation also runs over $x,y$ ? I think not}
\begin{equation}
  \begin{split}
