...
We provide more analysis over the choice of hyperparameters $k$ which is the number of activated nodes in each layer, i.e, controls the sharing level between the tasks. Table ~\ref{tab:K} shows the degradation of the performance when the number of activated nodes is reduced, and the sharing level between tasks decreases in consequence. 
\begin{table}[h!]
  \centering
  \begin{tabular}{|c|c|} \hline
    ...
    \hline
  \end{tabular}
  \caption{Variation of the performance w.r.t K while we fix $n_p=16$}
  \label{tab:K}
\end{table}
