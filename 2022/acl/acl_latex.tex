...
For all experiments, we report the BLEU score of \citet{Papineni02bleu} computed with SacreBleu \cite{Post18call}.\fyTodo{Check this}

\subsection{Datasets}
\subsubsection{Multidomain translation}
We use the same data as in the recent work of \citet{Pham21revisiting} on multidomain translation.\fyTodo{Add public to the data link} The datasets for the multidomain translation experiments are detailled in Table~\ref{tab:Corpora-chap4}.
\begin{table*}[h!]
  \centering
...
\begin{table*}[h!]
  ...
  \begin{tabular}{|p{4cm}|*{9}{r|}} \hline
    ...
    \hline
  \end{tabular}
  \caption{Experiments with multilingual translation.\fyTodo{What is the bold for ?}}
