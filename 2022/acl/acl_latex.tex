...
\begin{table*}[h!]
  ...
  \begin{tabular}{|p{4cm}|*{7}{r|}} \hline
    ...
    \system{LaMGD} Transformer   \hfill{\footnotesize[+0m]}  & 40.3 & \SB{60.4} & \SB{52.4} & \SB{39.0} & \SB{52.4} & \SB{87.5} & \SB{55.3} \\ 
    \hline
  \end{tabular}
  \caption{Multidomain translation experiment. Boldface denotes significant gains over \system{Transformer} ($p=0.05$)}
  \label{tab:mdmt}
\end{table*}
...
\begin{table*}[h!]
  ...
  \begin{tabular}{|p{4cm}|*{9}{r|}} \hline
    ...
    \revision{\system{Adapter}}   \hfill{\footnotesize[+13m]}  &10.2&4&13.3&21.9&32.2&34.1&38.5&8.3&20.31 \\ 
